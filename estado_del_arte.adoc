...
Algunas de esas métricas se detallan a continuación.
...
La otra técnica más frecuente es usar la predicción de una variable para posteriormente aplicar una técnica de miniería de relaciónes.
