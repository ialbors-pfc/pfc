...
* Distribución geográfica: ni los alumnos ni los profesores están restringidos a una ubicación geográfica única.
...
Si se toma como punto de referencia o punto de inflexión de esta disciplina la Primera Conferencia Internacional sobre EDM que tuvo lugar en 2008 en Montreal (http://educationalData Mining.org/conferences/) se aprecia que se trata de una disciplina joven sobre la que queda mucho por hacer.
...
La misma descripción de este objetivo cuenta con dos elementos diferenciados (_¿qué técnicas de Data Mining?_ y _¿sobre qué datos?_) cuyo espectro (que en su totalidad sería demasiado vasto y fuera del alcance de este proyecto) vamos a limitar.

Con respecto a las distintas técnicas de Data Mining se hará un repaso descriptivo por las más significativas de ellas.
