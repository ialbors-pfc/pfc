...
* la combinación de la publicación del _software_ con la publicación de un libro sobre Datamining en el que se emplea Weka como herramienta ilustrativa. Ambas cosas han funcionado como un círculo virtuoso.
